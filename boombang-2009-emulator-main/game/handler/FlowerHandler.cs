                    ...
                    switch (type)
                    {
                        case 1:
                            if (User.oro >= 10000)
                            {
                                ...
                                FlowerHandler.BoomBangTeam(Session, "¡Felicidades " + Session.User.nombre + " Ahora eres VIP 1 mes! \r\rTe notificaremos cuando tu suscripción termine faltando 15 días para que puedas renovar tu Membresía.");
                                server.AppendParameter(1);
                        ...
                        case 2:
                            if (User.oro >= 25000)
                            {
                                ...
                                FlowerHandler.BoomBangTeam(Session, "¡Felicidades " + Session.User.nombre + " Ahora eres VIP 3 meses! \r\rTe notificaremos cuando tu suscripción termine faltando 15 días para que puedas renovar tu Membresía.");
                                server.AppendParameter(1);
                                server.AppendParameter(User.end_vip);
                            }
                            else
                        ...
                        case 3:
                            if (User.oro >= 45000)
                            {
                                ...
                                FlowerHandler.BoomBangTeam(Session, "¡Felicidades " + Session.User.nombre + " Ahora eres VIP 6 meses! \r\rTe notificaremos cuando tu suscripción termine faltando 15 días para que puedas renovar tu Membresía.");
                                server.AppendParameter(1);
                                server.AppendParameter(User.end_vip);
                            }
                            else
